...
const readLastLinePromise = (path) => new Promise((resolve, reject) => {
...
const queryType = new GraphQLObjectType({
  ...
  fields: {
    ...
    diceRoll: {
      description:
        '**Simulate** a dice roll determined by count',
...
const appendLinePromise = (path, line) => new Promise((resolve, reject) => {
